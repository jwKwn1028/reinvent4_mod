...
def validate_lohc_panel(
    *,
    ...
    for name, smi in panel:
        ...
        has_dl = ring_has_double_like_bond(mol, count_aromatic_as_double=count_aromatic_as_double)
...
def main() -> None:
    ...
    ap.add_argument("--col", default="smiles", help="SMILES column name (default: smiles)")
    ...
    ap.add_argument("--max-hbd", type=int, default=1, help="Max H-bond donors (default: 1)")
    ap.add_argument("--max-tpsa", type=float, default=50.0, help="Max TPSA in Å^2 (default: 50)")
    ap.add_argument("--min-rotb", type=int, default=0, help="Min rotatable bonds (default: 0)")
    ap.add_argument("--max-rotb", type=int, default=9, help="Max rotatable bonds (default: 9)")
