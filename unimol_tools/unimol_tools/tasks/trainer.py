...
class Trainer(object):
    ...
    def __init__(self, save_path=None, **params):
        ...
        self.trial = params.get('trial', None)
    ...
    def _optuna_prune(self, epoch, metric_score):
        if self.trial:
            # Assume the first metric is the main one for pruning
            # metric_score is a dict like {'mse': 123.4}
            current_val = list(metric_score.values())[0]
    ...
    def fit_predict_wo_ddp(
        ...
        for epoch in range(self.max_epochs):
            ...
            self._optuna_prune(epoch, metric_score)
